 ...
 * Main controller
 **********************************************************************/
.controller('mainController', function($scope, $http, milesAPIservice, loggedIn, $location) {

loggedIn.checkLogin().then(function(res){
 ...
 **********************************************************************/
.controller('dashboardController', function($scope, $http, milesAPIservice, loggedIn, $animate, ngDialog) {
	loggedIn.checkLogin().then(function(res){
	console.log(res.data);	
})
...
.controller('userController', function($scope, $routeParams, $http, milesAPIservice, $animate, loggedIn) {
	loggedIn.checkLogin().then(function(res){
	console.log(res.data);
})
 ...
 * Register controller
 **********************************************************************/
.controller('registerController', function($scope, $http, milesAPIservice, loggedIn) {
loggedIn.checkLogin().then(function(res){
	console.log(res.data);
})
 ...
 * Login controller
 **********************************************************************/
.controller('loginController', function($scope, $rootScope, $http, $location, loggedIn) {
 ...
 * Account controller
 **********************************************************************/
.controller('accountController', function($scope, $http, $routeParams, milesAPIservice, loggedIn) {
 ...
 **********************************************************************/
.controller('taskQueueController', function($scope, $http, $location, milesAPIservice, loggedIn) {
